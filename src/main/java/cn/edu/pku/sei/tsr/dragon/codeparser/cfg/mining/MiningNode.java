...
public class MiningNode {
	...
	public static final MiningNode POST_INCREMENT = new MiningNode(OPType.OP, "POST_INCREMENT");
	public static final MiningNode POST_DECREMENT = new MiningNode(OPType.OP, "POST_DECREMENT");
	...
	public static final MiningNode PRE_INCREMENT = new MiningNode(OPType.OP, "PRE_INCREMENT");
	public static final MiningNode PRE_DECREMENT = new MiningNode(OPType.OP, "PRE_DECREMENT");
