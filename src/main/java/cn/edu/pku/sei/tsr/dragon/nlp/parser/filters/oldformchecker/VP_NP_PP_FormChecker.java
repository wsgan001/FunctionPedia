...
public class VP_NP_PP_FormChecker {
	...
	public static boolean check(PhraseInfo phrase) {
		...
		// "__ < ( NP [</NN.*/ | [!< /NN.*/ < (NP < /NN.*/)]] ) < ( PP [</NN.*/ | [!< /NN.*/ < (NP < /NN.*/)]])";
		String filterPattern = "__ < " + Rules.NP_NN_PATTERN + " < " + Rules.PP_PATTERN;
		...
		if (matcher.matches()) {
			...
			proof.setType(ProofType.PASS_VP_NP_PP_FORM);
