...
public class GraphUtils {
	...
	public static boolean isStopVerb(String str) {// 在规则制定的停用词列表里面过滤动词
		return Rules.qa_verbs.contains(str) || Rules.stop_verbs.contains(str)
				|| Rules.unlike_verbs.contains(str) || Arrays.asList(Rules.BE_VERBS).contains(str)
	...
	public static boolean isStopNoun(String str) {// 在规则制定的停用词列表里面过滤名词
		return Rules.qa_nouns.contains(str) || Rules.stop_nouns.contains(str)
				|| Rules.unlike_nouns.contains(str);
	}
